...
describe('Styles', () => {
  ...
  describe('Box', () => {
    ...
    test('[Box][width]-Responsive Array', () => {
      expect(Box({width: [1, 0.5, 0.5]})).toEqual({
        width: '100%',
    ...
    test('[Box][width]-Responsive Object', () => {
      expect(Box({width: {default: 1, tablet: 0.5, laptop: 0.5}})).toEqual({
        width: '100%',
        '@media screen and (min-width:40em)': {width: '50%'},
        '@media screen and (min-width:52em)': {width: '50%'},
      })
    ...
    test('[Box][color]', () => {
      expect(Box({bg: 'blue', color: 'red'})).toEqual({
    ...
    test('[Box][color]-Responsive Array', () => {
      expect(Box({bg: [undefined, 'blue'], color: ['red', 'white']})).toEqual({
        '@media screen and (min-width:40em)': {
          backgroundColor: 'blue',
          color: 'white',
        },
    ...
    test('[Box][color]-Responsive Object', () => {
      expect(
        Box({bg: {tablet: 'blue'}, color: {default: 'red', tablet: 'white'}}),
      ).toEqual({
        '@media screen and (min-width:40em)': {
          backgroundColor: 'blue',
          color: 'white',
