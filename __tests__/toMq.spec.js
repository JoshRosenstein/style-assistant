...
describe('toMq',()=>{
  ...
  test('Returns self if string and atRule',()=>{
    ...
    expect(toMq('@media screen and (min-width:1em)')).toEqual('@media screen and (min-width:1em)')
  ...
  test('False',()=>{
    ...
    expect(toMq([{min:'1em',handheld: false}])).toEqual('@media (min-width:1em) and not handheld')
